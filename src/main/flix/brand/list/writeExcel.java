...
//        }
    ...
    // Extra test. For individual adding brands

//    private void createContent(WritableSheet sheet) throws WriteException { // Add brand contents to Excel
//        // Write data by the detected last row or the very first
//        addLabel(sheet, 0, rowNum, brand.getString("category"));
//        addLabel(sheet, 1, rowNum, brand.getString("brand"));
//
//        if (brand.getString("company") != null) { addLabel(sheet, 2, rowNum, brand.getString("company"));
//        } else { addLabel(sheet, 2, rowNum, null); }
//
//        if (brand.getString("product") != null) { addLabel(sheet, 3, rowNum, brand.getString("product"));
//        } else { addLabel(sheet, 3, rowNum, null); }
//
//        if (brand.getString("country") != null) { addLabel(sheet, 4, rowNum, brand.getString("country"));
//        } else { addLabel(sheet, 4, rowNum, null); }
//    }
//
//    public static void main(String[] args) throws IOException, WriteException, BiffException {
//        String json = "{\"category\"  : \"example\", " +
//                "\"brand\" : \"br\", " +
//                "\"company\" : \"br product\", " +
//                "\"product\" : \"product\", " +
//                "\"country\" : \"USA\"}";
//        String json1 = "{\"category\"  : \"example\", " +
//                "\"brand\" : \"br2\", " +
//                "\"company\" : \"br2 product\", " +
//                "\"product\" : \"product\", " +
//                "\"country\" : \"Mexico\"}";
